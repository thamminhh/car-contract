...
namespace CleanArchitecture.Application.Repository
{
    public class TransferContractRepository : ITransferContractRepository
    {
        ...
        public void CreateTransferContract(TransferContractCreateModel request)
        {
            ...
            htmlContent += "<h2 style='text-align: center;'>BIÊN BẢN GIAO XE</h2>";
            ...
            htmlContent += "</ul>";
            htmlContent += "<h2>C.  Bên A có giữ của bên B số tiền cọc như sau:</h2>";
            htmlContent += "<li>Tiền mặt, số tiền: " + request.DepositItemDownPayment + " VNĐ</li>";
        ...
        public void UpdateTransferContract(int id, TransferContractUpdateModel request)
        {
            ...
            if (request.StaffSignature != null && request.CustomerSignature == null)
            {
                htmlContent += "&nbsp;&nbsp;&nbsp;&nbsp;<img style= 'width:100px; height:100%' src='" + request.StaffSignature + "' />";
                htmlContent += "<li> " + transferer.Name + "</li>";
            }
            if (request.StaffSignature != null && request.CustomerSignature != null)
            {
                htmlContent += "&nbsp;&nbsp;&nbsp;&nbsp;<img style= 'width:100px; height:100%' src='" + request.StaffSignature + "'/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                ...
                ";&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
                "<img style= 'width:100px; height:100%' src='" + request.CustomerSignature + "' />";

                htmlContent += "<li>&nbsp;&nbsp;&nbsp;&nbsp;" + transferer.Name +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
               "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
               "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp" +
               ";&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" +
               "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + contractGroup.CustomerInfo.CustomerName + "</li>";
