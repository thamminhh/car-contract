    ...
    public class TransferContractRepository : ITransferContractRepository
    {
        ...
        public TransferContractDataModel GetTransferContractById(int id)
        {
            ...
            return new TransferContractDataModel
            {
                ...
                RepresentativeId = contractGroup.RentContract.RepresentativeId,
                ...
                CurrentCarStateCarFrontImg = transferContract.CurrentCarStateCarFrontImg,
                CurrentCarStateCarBackImg = transferContract.CurrentCarStateCarBackImg,
                CurrentCarStateCarLeftImg = transferContract.CurrentCarStateCarLeftImg,
                CurrentCarStateCarRightImg = transferContract.CurrentCarStateCarRightImg,
                CurrentCarStateCarInteriorImg = transferContract.CurrentCarStateCarInteriorImg,
                CurrentCarStateCarBackSeatImg = transferContract.CurrentCarStateCarBackSeatImg,
                DepositItemPaper = transferContract.DepositItemPaper,
                DepositItemAsset = transferContract.DepositItemAsset,
                DepositItemAssetInfo = transferContract.DepositItemAssetInfo,
        ...
        public void CreateTransferContract(TransferContractCreateModel request)
        {
            ...
            string fileName = "TransferContract" + ".pdf";
