...
namespace CleanArchitecture.Domain.Interface
{
    public interface ICarRepository
    {
        ...
        ICollection<CarDataModel> GetCarsMaintenance(int page, int pageSize, int? parkingLotId, out int count);
        ICollection<CarDataModel> GetCarsMaintenanceByParkingLotId(int page, int pageSize, int parkingLotId, out int count);
        ICollection<CarDataModel> GetCarsRegistry(int page, int pageSize, int? parkingLotId, out int count);
        ...
        bool CreateCarByExcel(CarCreateExcelModel request, out string errorMessage);
